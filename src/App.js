...
const translations = {
  pt: {
    ...
    home_tagline: "Prepare-se para a maior experiência da sua vida.",
    ...
    video_tutorial_title: "Bem-vindo(a) ao PrepX",
    ...
    copyright: `© ${new Date().getFullYear()} PrepX. Todos os direitos reservados.`,
    ...
    notification_negotiation_desc: "Use o cupom PREPXINTER5 em nossas agências parceiras e ganhe 5% de desconto na compra do seu intercâmbio.",
    notification_visa_title: "Cupom para Visto!",
    notification_visa_desc: "Use o cupom PREPXINTER5 em nossas agências parceiras e ganhe 5% de desconto na assessoria do seu visto. Válido para vistos solicitados no Brasil.",
    notification_insurance_title: "Cupom para Seguro!",
    notification_insurance_desc: "Use o cupom PREPXINTER5 em nossas agências parceiras e ganhe 5% de desconto na compra do seu Seguro Viagem.",
    ...
    guide_form_desc: "Preencha seus dados para receber o Guia Definitivo do Intercâmbio PrepX no seu e-mail.",
...
const AppLogo = () => {
    const { t } = useLanguage();
    return (
        <svg width="300" height="120" viewBox="0 0 300 120" xmlns="http://www.w3.org/2000/svg" className="text-center">
             <defs>
                ...
                <filter id="x-glow" x="-50%" y="-50%" width="200%" height="200%">
                    <feDropShadow dx="0" dy="0" stdDeviation="4" floodColor="var(--accent-glow)" />
                </filter>
            </defs>
            <text x="50%" y="35" dominantBaseline="middle" textAnchor="middle" fontSize="48" fontWeight="300" fontFamily="Inter, sans-serif" fill="url(#logoGradient)" letterSpacing="1">Prep</text>
            <text x="50%" y="35" dominantBaseline="middle" textAnchor="middle" fontSize="48" fontWeight="bold" fontFamily="Inter, sans-serif" fill="#F5F5F5" stroke="#4A5568" strokeWidth="0.3" filter="url(#x-glow)" style={{transform: 'translateX(62px)'}}>X</text>
            <text x="50%" y="70" dominantBaseline="middle" textAnchor="middle" fontSize="18" fontWeight="300" fontFamily="Inter, sans-serif" fill="var(--text-primary)" letterSpacing="0.05em">Intercâmbio</text>
            <text x="50%" y="98" dominantBaseline="middle" textAnchor="middle" fontSize="12" fontWeight="400" fontFamily="Inter, sans-serif" fill="var(--text-secondary)">{t('home_tagline')}</text>
        </svg>
    );
};
