...
const AppProvider = ({ children }) => {
    ...
    const [activePanel, setActivePanel] = useState(null); // e.g., 'addClient', 'notifications', 'clientDetail'
    const [panelData, setPanelData] = useState(null); // Data for the active panel, e.g., client object
    ...
    const handleAgencyLogin = (type) => { // type can be 'agency' or 'consultant'
